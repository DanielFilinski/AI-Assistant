...
var require_middleware = __commonJS({
  ".next/server/middleware.js"() {
    "use strict";
    (self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[751], { 1213: (a) => {
      (() => {
        "use strict";
        var b = { 993: (a2) => {
      ...
      "use strict";
      let d;
      c.r(b), c.d(b, { default: () => bt });
      var e, f = {};
      async function g() {
        return "_ENTRIES" in globalThis && _ENTRIES.middleware_instrumentation && await _ENTRIES.middleware_instrumentation;
      }
      c.r(f), c.d(f, { config: () => bo, middleware: () => bp });
      let h = null;
      async function i() {
...
Learn More: https://nextjs.org/docs/messages/node-module-in-edge-runtime`;
  ...
  `);
      ...
      let ap = ["Middleware.execute", "BaseServer.handleRequest", "Render.getServerSideProps", "Render.getStaticProps", "AppRender.fetch", "AppRender.getBodyResult", "Render.renderDocument", "Node.runHandler", "AppRouteRouteHandlers.runHandler", "ResolveMetadata.generateMetadata", "ResolveMetadata.generateViewport", "NextNodeServer.createComponentTree", "NextNodeServer.findPageComponents", "NextNodeServer.getLayoutOrPageModule", "NextNodeServer.startResponse", "NextNodeServer.clientComponentLoading"], aq = ["NextNodeServer.findPageComponents", "NextNodeServer.createComponentTree", "NextNodeServer.clientComponentLoading"];
      function ar(a10) {
        return null !== a10 && "object" == typeof a10 && "then" in a10 && "function" == typeof a10.then;
      }
      let { context: as, propagation: at, trace: au, SpanStatusCode: av, SpanKind: aw, ROOT_CONTEXT: ax } = d = c(3817);
      ...
      let az = (a10, b2) => {
        (function(a11) {
          return "object" == typeof a11 && null !== a11 && a11 instanceof ay;
        })(b2) && b2.bubble ? a10.setAttribute("next.bubble", true) : (b2 && (a10.recordException(b2), a10.setAttribute("error.type", b2.name)), a10.setStatus({ code: av.ERROR, message: null == b2 ? void 0 : b2.message })), a10.end();
      }, aA = /* @__PURE__ */ new Map(), aB = d.createContextKey("next.rootSpanId"), aC = 0, aD = { set(a10, b2, c2) {
        a10.push({ key: b2, value: c2 });
      } };
      class aE {
        getTracerInstance() {
          return au.getTracer("next.js", "0.0.1");
        }
        getContext() {
          return as;
        }
        getTracePropagationData() {
          let a10 = as.active(), b2 = [];
          return at.inject(a10, b2, aD), b2;
        }
        getActiveScopeSpan() {
          return au.getSpan(null == as ? void 0 : as.active());
        }
        withPropagatedContext(a10, b2, c2) {
          let d2 = as.active();
          if (au.getSpanContext(d2)) return b2();
          let e2 = at.extract(d2, a10, c2);
          return as.with(e2, b2);
        }
        trace(...a10) {
          var b2;
          let [c2, d2, e2] = a10, { fn: f2, options: g2 } = "function" == typeof d2 ? { fn: d2, options: {} } : { fn: e2, options: { ...d2 } }, h2 = g2.spanName ?? c2;
          if (!ap.includes(c2) && "1" !== process.env.NEXT_OTEL_VERBOSE || g2.hideSpan) return f2();
          let i2 = this.getSpanContext((null == g2 ? void 0 : g2.parentSpan) ?? this.getActiveScopeSpan()), j2 = false;
          i2 ? (null == (b2 = au.getSpanContext(i2)) ? void 0 : b2.isRemote) && (j2 = true) : (i2 = (null == as ? void 0 : as.active()) ?? ax, j2 = true);
          let k2 = aC++;
          return g2.attributes = { "next.span_name": h2, "next.span_type": c2, ...g2.attributes }, as.with(i2.setValue(aB, k2), () => this.getTracerInstance().startActiveSpan(h2, g2, (a11) => {
            let b3 = "performance" in globalThis && "measure" in performance ? globalThis.performance.now() : void 0, d3 = () => {
              aA.delete(k2), b3 && process.env.NEXT_OTEL_PERFORMANCE_PREFIX && aq.includes(c2 || "") && performance.measure(`${process.env.NEXT_OTEL_PERFORMANCE_PREFIX}:next-${(c2.split(".").pop() || "").replace(/[A-Z]/g, (a12) => "-" + a12.toLowerCase())}`, { start: b3, end: performance.now() });
            };
            j2 && aA.set(k2, new Map(Object.entries(g2.attributes ?? {})));
            try {
              if (f2.length > 1) return f2(a11, (b5) => az(a11, b5));
              let b4 = f2(a11);
              if (ar(b4)) return b4.then((b5) => (a11.end(), b5)).catch((b5) => {
                throw az(a11, b5), b5;
              }).finally(d3);
              return a11.end(), d3(), b4;
            } catch (b4) {
              throw az(a11, b4), d3(), b4;
            }
          }));
        }
        wrap(...a10) {
          let b2 = this, [c2, d2, e2] = 3 === a10.length ? a10 : [a10[0], {}, a10[1]];
          return ap.includes(c2) || "1" === process.env.NEXT_OTEL_VERBOSE ? function() {
            let a11 = d2;
            ...
            {
              let d3 = b2.getContext().bind(as.active(), g2);
        ...
        getSpanContext(a10) {
          return a10 ? au.setSpan(as.active(), a10) : void 0;
        }
        getRootSpanAttributes() {
          let a10 = as.active().getValue(aB);
          return aA.get(a10);
        }
        setRootSpanAttribute(a10, b2) {
          let c2 = as.active().getValue(aB), d2 = aA.get(c2);
          d2 && d2.set(a10, b2);
        }
      }
      let aF = (() => {
        let a10 = new aE();
        return () => a10;
      })(), aG = "__prerender_bypass";
      Symbol("__next_preview_data"), Symbol(aG);
      class aH {
        constructor(a10, b2, c2, d2) {
          ...
          }(b2, a10).isOnDemandRevalidate, g2 = null == (e2 = c2.get(aG)) ? void 0 : e2.value;
        ...
        enable() {
          ...
          this._mutableCookies.set({ name: aG, value: this._previewModeId, httpOnly: true, sameSite: "none", secure: true, path: "/" }), this._isEnabled = true;
        }
        disable() {
          this._mutableCookies.set({ name: aG, value: "", httpOnly: true, sameSite: "none", secure: true, path: "/", expires: /* @__PURE__ */ new Date(0) }), this._isEnabled = false;
        }
      }
      function aI(a10, b2) {
      ...
      class aP {
        constructor(a10, b2) {
          this.cache = /* @__PURE__ */ new Map(), this.totalSize = 0, this.maxSize = a10, this.calculateSize = b2, this.head = new aO(), this.tail = new aO(), this.head.next = this.tail, this.tail.prev = this.head;
        }
        addToHead(a10) {
      ...
      c(5356).Buffer, new aP(52428800, (a10) => a10.size), process.env.NEXT_PRIVATE_DEBUG_CACHE && console.debug.bind(console, "DefaultCacheHandler:"), process.env.NEXT_PRIVATE_DEBUG_CACHE && ((a10, ...b2) => {
        console.log(`use-cache: ${a10}`, ...b2);
      }), Symbol.for("@next/cache-handlers");
      let aQ = Symbol.for("@next/cache-handlers-map"), aR = Symbol.for("@next/cache-handlers-set"), aS = globalThis;
      function aT() {
        if (aS[aQ]) return aS[aQ].entries();
      }
      async function aU(a10, b2) {
        if (!a10) return b2();
        let c2 = aV(a10);
        try {
          return await b2();
      ...
      async function aX(a10, b2) {
        ...
        return Promise.all([aW(c2, a10.incrementalCache), ...Object.values(d2), ...e2]);
      }
      let aY = Object.defineProperty(Error("Invariant: AsyncLocalStorage accessed in runtime where it is not available"), "__NEXT_ERROR_CODE", { value: "E504", enumerable: false, configurable: true });
      class aZ {
        disable() {
          throw aY;
        }
      ...
      let a$ = "undefined" != typeof globalThis && globalThis.AsyncLocalStorage, a_ = a$ ? new a$() : new aZ();
      class a0 {
        constructor({ waitUntil: a10, onClose: b2, onTaskError: c2 }) {
          this.workUnitStores = /* @__PURE__ */ new Set(), this.waitUntil = a10, this.onClose = b2, this.onTaskError = c2, this.callbackQueue = new (aL())(), this.callbackQueue.pause();
        }
        after(a10) {
          if (ar(a10)) this.waitUntil || a1(), this.waitUntil(a10.catch((a11) => this.reportTaskError("promise", a11)));
        ...
        addCallback(a10) {
          var b2;
          this.waitUntil || a1();
          let c2 = aJ.e.getStore();
          c2 && this.workUnitStores.add(c2);
          let d2 = a_.getStore(), e2 = d2 ? d2.rootTaskSpawnPhase : null == c2 ? void 0 : c2.phase;
          this.runCallbacksOnClosePromise || (this.runCallbacksOnClosePromise = this.runCallbacksOnClose(), this.waitUntil(this.runCallbacksOnClosePromise));
          let f2 = (b2 = async () => {
            try {
              await a_.run({ rootTaskSpawnPhase: e2 }, () => a10());
            } catch (a11) {
              this.reportTaskError("function", a11);
            }
          }, a$ ? a$.bind(b2) : aZ.bind(b2));
        ...
        async runCallbacks() {
          ...
          let a10 = Z.I.getStore();
          if (!a10) throw Object.defineProperty(new aM("Missing workStore in AfterContext.runCallbacks"), "__NEXT_ERROR_CODE", { value: "E547", enumerable: false, configurable: true });
          return aU(a10, () => (this.callbackQueue.start(), this.callbackQueue.onIdle()));
        }
        reportTaskError(a10, b2) {
          if (console.error("promise" === a10 ? "A promise passed to `after()` rejected:" : "An error occurred in a function passed to `after()`:", b2), this.onTaskError) try {
            ...
            console.error(Object.defineProperty(new aM("`onTaskError` threw while handling an error thrown from an `after` task", { cause: a11 }), "__NEXT_ERROR_CODE", { value: "E569", enumerable: false, configurable: true }));
          }
        }
      }
      function a1() {
      ...
      let a5 = Symbol.for("@next/request-context");
      async function a6(a10, b2, c2) {
        ...
        return { tags: d2, expirationsByCacheKind: function(a11) {
          let b3 = /* @__PURE__ */ new Map(), c3 = aT();
          if (c3) for (let [d3, e3] of c3) "getExpiration" in e3 && b3.set(d3, a2(async () => e3.getExpiration(...a11)));
          return b3;
        }(d2) };
      }
      class a7 extends N {
      ...
      let a8 = { keys: (a10) => Array.from(a10.keys()), get: (a10, b2) => a10.get(b2) ?? void 0 }, a9 = (a10, b2) => aF().withPropagatedContext(a10.headers, b2, a8), ba = false;
      async function bb(a10) {
        var b2;
        let d2, e2;
        if (!ba && (ba = true, "true" === process.env.NEXT_PRIVATE_TEST_PROXY)) {
        ...
        let n2 = g2.searchParams.get(W), o2 = new a7({ page: a10.page, input: function(a11) {
        ...
        if ((d2 = await a9(o2, () => {
          if ("/middleware" === a10.page || "/src/middleware" === a10.page) {
            let b3 = q2.waitUntil.bind(q2), c2 = new a3();
            return aF().trace(ao.execute, { spanName: `middleware ${o2.method} ${o2.nextUrl.pathname}`, attributes: { "http.target": o2.nextUrl.pathname, "http.method": o2.method } }, async () => {
              try {
                var d3, f3, g3, i3, j3, k3;
                let l2 = a4(), m3 = await a6("/", o2.nextUrl, null), n3 = (j3 = o2.nextUrl, k3 = (a11) => {
                  e2 = a11;
                  ...
                  return { type: "request", phase: a11, implicitTags: f4, url: { pathname: d4.pathname, search: d4.search ?? "" }, rootParams: e3, get headers() {
                    ...
                    if (!n4.cookies) {
                      ...
                      aI(b4, a12), n4.cookies = _.seal(a12);
                    }
                    return n4.cookies;
                  }, set cookies(value) {
                    n4.cookies = value;
                    ...
                    if (!n4.mutableCookies) {
                      let a12 = function(a13, b5) {
                        ...
                        return ab.wrap(c4, b5);
                      }(b4.headers, g4 || (c3 ? m4 : void 0));
                      aI(b4, a12), n4.mutableCookies = a12;
                    }
                    ...
                    return n4.userspaceMutableCookies || (n4.userspaceMutableCookies = function(a12) {
                      let b5 = new Proxy(a12.mutableCookies, { get(c4, d5, e4) {
                        switch (d5) {
                          case "delete":
                            return function(...d6) {
                              return ac(a12, "cookies().delete"), c4.delete(...d6), b5;
                            };
                          case "set":
                            return function(...d6) {
                              return ac(a12, "cookies().set"), c4.set(...d6), b5;
                            };
                          default:
                    ...
                    return n4.draftMode || (n4.draftMode = new aH(i4, b4, this.cookies, this.mutableCookies)), n4.draftMode;
                  ...
                  let g4 = !b4.shouldWaitOnAllReady && !b4.supportsDynamicResponse && !b4.isDraftMode && !b4.isPossibleServerAction, h3 = b4.dev ?? false, i4 = h3 || g4 && (!!process.env.NEXT_DEBUG_BUILD || "1" === process.env.NEXT_SSG_FETCH_METRICS), j4 = { isStaticGeneration: g4, page: a11, route: (f4 = a11.split("/").reduce((a12, b5, c4, d5) => b5 ? "(" === b5[0] && b5.endsWith(")") || "@" === b5[0] || ("page" === b5 || "route" === b5) && c4 === d5.length - 1 ? a12 : a12 + "/" + b5 : a12, "")).startsWith("/") ? f4 : "/" + f4, incrementalCache: b4.incrementalCache || globalThis.__incrementalCache, cacheLifeProfiles: b4.cacheLifeProfiles, isRevalidate: b4.isRevalidate, isBuildTimePrerendering: b4.nextExport, hasReadableErrorStacks: b4.hasReadableErrorStacks, fetchCache: b4.fetchCache, isOnDemandRevalidate: b4.isOnDemandRevalidate, isDraftMode: b4.isDraftMode, isPrefetchRequest: c3, buildId: d4, reactLoadableManifest: (null == b4 ? void 0 : b4.reactLoadableManifest) || {}, assetPrefix: (null == b4 ? void 0 : b4.assetPrefix) || "", afterContext: function(a12) {
                    ...
                    return new a0({ waitUntil: b5, onClose: c4, onTaskError: d5 });
                    ...
                    let a12 = /* @__PURE__ */ new Map(), b5 = aT();
                    if (b5) for (let [c4, d5] of b5) "refreshTags" in d5 && a12.set(c4, a2(async () => d5.refreshTags()));
                    return a12;
                  }(), runInCleanSnapshot: a$ ? a$.snapshot() : function(a12, ...b5) {
                    return a12(...b5);
                ...
                return await Z.I.run(p3, () => aJ.e.run(n3, a10.handler, o2, q2));
              } finally {
                setTimeout(() => {
                  c2.dispatchClose();
                }, 0);
      ...
      var bc = c(7814);
      if (/* @__PURE__ */ new WeakMap(), bc.unstable_postpone, false === function(a10) {
      ...
      let { env: bd, stdout: be } = (null == (e = globalThis) ? void 0 : e.process) ?? {}, bf = bd && !bd.NO_COLOR && (bd.FORCE_COLOR || (null == be ? void 0 : be.isTTY) && !bd.CI && "dumb" !== bd.TERM), bg = (a10, b2, c2, d2) => {
        let e2 = a10.substring(0, d2) + c2, f2 = a10.substring(d2 + b2.length), g2 = f2.indexOf(b2);
        return ~g2 ? e2 + bg(f2, b2, c2, g2) : e2 + f2;
      }, bh = (a10, b2, c2 = a10) => bf ? (d2) => {
        let e2 = "" + d2, f2 = e2.indexOf(b2, a10.length);
        return ~f2 ? a10 + bg(e2, b2, c2, f2) + b2 : a10 + e2 + b2;
      } : String, bi = bh("\x1B[1m", "\x1B[22m", "\x1B[22m\x1B[1m");
      bh("\x1B[2m", "\x1B[22m", "\x1B[22m\x1B[2m"), bh("\x1B[3m", "\x1B[23m"), bh("\x1B[4m", "\x1B[24m"), bh("\x1B[7m", "\x1B[27m"), bh("\x1B[8m", "\x1B[28m"), bh("\x1B[9m", "\x1B[29m"), bh("\x1B[30m", "\x1B[39m");
      let bj = bh("\x1B[31m", "\x1B[39m"), bk = bh("\x1B[32m", "\x1B[39m"), bl = bh("\x1B[33m", "\x1B[39m");
      bh("\x1B[34m", "\x1B[39m");
      let bm = bh("\x1B[35m", "\x1B[39m");
      bh("\x1B[38;2;173;127;168m", "\x1B[39m"), bh("\x1B[36m", "\x1B[39m");
      let bn = bh("\x1B[37m", "\x1B[39m");
      bh("\x1B[90m", "\x1B[39m"), bh("\x1B[40m", "\x1B[49m"), bh("\x1B[41m", "\x1B[49m"), bh("\x1B[42m", "\x1B[49m"), bh("\x1B[43m", "\x1B[49m"), bh("\x1B[44m", "\x1B[49m"), bh("\x1B[45m", "\x1B[49m"), bh("\x1B[46m", "\x1B[49m"), bh("\x1B[47m", "\x1B[49m"), bn(bi("\u25CB")), bj(bi("\u2A2F")), bl(bi("\u26A0")), bn(bi(" ")), bk(bi("\u2713")), bm(bi("\xBB")), new aP(1e4, (a10) => a10.length), /* @__PURE__ */ new WeakMap();
      let bo = { matcher: ["/form/:path*"] };
      function bp(a10) {
        return a10.cookies.get("session_token") ? S.next() : S.redirect(new URL("/login", a10.url));
      }
      Object.values({ NOT_FOUND: 404, FORBIDDEN: 403, UNAUTHORIZED: 401 });
      let bq = { ...f }, br = bq.middleware || bq.default, bs = "/middleware";
      if ("function" != typeof br) throw Object.defineProperty(Error(`The Middleware "${bs}" must export a \`middleware\` or a \`default\` function`), "__NEXT_ERROR_CODE", { value: "E120", enumerable: false, configurable: true });
      function bt(a10) {
        return bb({ ...a10, page: bs, handler: async (...a11) => {
          try {
            return await br(...a11);
          } catch (e2) {
...
var init_edgeFunctionHandler = __esm({
  "node_modules/@opennextjs/aws/dist/core/edgeFunctionHandler.js"() {
    ...
    globalThis._ROUTES = [{ "name": "middleware", "page": "/", "regex": ["^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/form(?:\\/((?:[^\\/#\\?]+?)(?:\\/(?:[^\\/#\\?]+?))*))?(\\.json)?[\\/#\\?]?$"] }];
...
var NextConfig = { "env": {}, "webpack": null, "eslint": { "ignoreDuringBuilds": true }, "typescript": { "ignoreBuildErrors": false, "tsconfigPath": "tsconfig.json" }, "typedRoutes": false, "distDir": ".next", "cleanDistDir": true, "assetPrefix": "", "cacheMaxMemorySize": 52428800, "configOrigin": "next.config.ts", "useFileSystemPublicRoutes": true, "generateEtags": true, "pageExtensions": ["tsx", "ts", "jsx", "js"], "poweredByHeader": true, "compress": true, "images": { "deviceSizes": [640, 750, 828, 1080, 1200, 1920, 2048, 3840], "imageSizes": [16, 32, 48, 64, 96, 128, 256, 384], "path": "/_next/image", "loader": "default", "loaderFile": "", "domains": [], "disableStaticImages": false, "minimumCacheTTL": 60, "formats": ["image/webp"], "dangerouslyAllowSVG": false, "contentSecurityPolicy": "script-src 'none'; frame-src 'none'; sandbox;", "contentDispositionType": "attachment", "remotePatterns": [], "unoptimized": false }, "devIndicators": { "position": "bottom-left" }, "onDemandEntries": { "maxInactiveAge": 6e4, "pagesBufferLength": 5 }, "amp": { "canonicalBase": "" }, "basePath": "", "sassOptions": {}, "trailingSlash": false, "i18n": null, "productionBrowserSourceMaps": false, "excludeDefaultMomentLocales": true, "serverRuntimeConfig": {}, "publicRuntimeConfig": {}, "reactProductionProfiling": false, "reactStrictMode": null, "reactMaxHeadersLength": 6e3, "httpAgentOptions": { "keepAlive": true }, "logging": {}, "compiler": {}, "expireTime": 31536e3, "staticPageGenerationTimeout": 60, "output": "standalone", "modularizeImports": { "@mui/icons-material": { "transform": "@mui/icons-material/{{member}}" }, "lodash": { "transform": "lodash/{{member}}" } }, "outputFileTracingRoot": "/Volumes/FilinSky/PROJECTS/Ai Assistant/smart-form-assistant", "experimental": { "useSkewCookie": false, "cacheLife": { "default": { "stale": 300, "revalidate": 900, "expire": 4294967294 }, "seconds": { "stale": 30, "revalidate": 1, "expire": 60 }, "minutes": { "stale": 300, "revalidate": 60, "expire": 3600 }, "hours": { "stale": 300, "revalidate": 3600, "expire": 86400 }, "days": { "stale": 300, "revalidate": 86400, "expire": 604800 }, "weeks": { "stale": 300, "revalidate": 604800, "expire": 2592e3 }, "max": { "stale": 300, "revalidate": 2592e3, "expire": 4294967294 } }, "cacheHandlers": {}, "cssChunking": true, "multiZoneDraftMode": false, "appNavFailHandling": false, "prerenderEarlyExit": true, "serverMinification": true, "serverSourceMaps": false, "linkNoTouchStart": false, "caseSensitiveRoutes": false, "clientSegmentCache": false, "clientParamParsing": false, "dynamicOnHover": false, "preloadEntriesOnStart": true, "clientRouterFilter": true, "clientRouterFilterRedirects": false, "fetchCacheKeyPrefix": "", "middlewarePrefetch": "flexible", "optimisticClientCache": true, "manualClientBasePath": false, "cpus": 7, "memoryBasedWorkersCount": false, "imgOptConcurrency": null, "imgOptTimeoutInSeconds": 7, "imgOptMaxInputPixels": 268402689, "imgOptSequentialRead": null, "imgOptSkipMetadata": null, "isrFlushToDisk": true, "workerThreads": false, "optimizeCss": false, "nextScriptWorkers": false, "scrollRestoration": false, "externalDir": false, "disableOptimizedLoading": false, "gzipSize": true, "craCompat": false, "esmExternals": true, "fullySpecified": false, "swcTraceProfiling": false, "forceSwcTransforms": false, "largePageDataBytes": 128e3, "typedEnv": false, "parallelServerCompiles": false, "parallelServerBuildTraces": false, "ppr": false, "authInterrupts": false, "webpackMemoryOptimizations": false, "optimizeServerReact": true, "viewTransition": false, "routerBFCache": false, "removeUncaughtErrorAndRejectionListeners": false, "validateRSCRequestHeaders": false, "staleTimes": { "dynamic": 0, "static": 300 }, "serverComponentsHmrCache": true, "staticGenerationMaxConcurrency": 8, "staticGenerationMinPagesPerWorker": 25, "cacheComponents": false, "inlineCss": false, "useCache": false, "globalNotFound": false, "devtoolSegmentExplorer": true, "browserDebugInfoInTerminal": false, "optimizeRouterScrolling": false, "serverActions": { "allowedOrigins": ["*"] }, "optimizePackageImports": ["lucide-react", "date-fns", "lodash-es", "ramda", "antd", "react-bootstrap", "ahooks", "@ant-design/icons", "@headlessui/react", "@headlessui-float/react", "@heroicons/react/20/solid", "@heroicons/react/24/solid", "@heroicons/react/24/outline", "@visx/visx", "@tremor/react", "rxjs", "@mui/material", "@mui/icons-material", "recharts", "react-use", "effect", "@effect/schema", "@effect/platform", "@effect/platform-node", "@effect/platform-browser", "@effect/platform-bun", "@effect/sql", "@effect/sql-mssql", "@effect/sql-mysql2", "@effect/sql-pg", "@effect/sql-sqlite-node", "@effect/sql-sqlite-bun", "@effect/sql-sqlite-wasm", "@effect/sql-sqlite-react-native", "@effect/rpc", "@effect/rpc-http", "@effect/typeclass", "@effect/experimental", "@effect/opentelemetry", "@material-ui/core", "@material-ui/icons", "@tabler/icons-react", "mui-core", "react-icons/ai", "react-icons/bi", "react-icons/bs", "react-icons/cg", "react-icons/ci", "react-icons/di", "react-icons/fa", "react-icons/fa6", "react-icons/fc", "react-icons/fi", "react-icons/gi", "react-icons/go", "react-icons/gr", "react-icons/hi", "react-icons/hi2", "react-icons/im", "react-icons/io", "react-icons/io5", "react-icons/lia", "react-icons/lib", "react-icons/lu", "react-icons/md", "react-icons/pi", "react-icons/ri", "react-icons/rx", "react-icons/si", "react-icons/sl", "react-icons/tb", "react-icons/tfi", "react-icons/ti", "react-icons/vsc", "react-icons/wi"], "trustHostHeader": false, "isExperimentalCompile": false }, "htmlLimitedBots": "[\\w-]+-Google|Google-[\\w-]+|Chrome-Lighthouse|Slurp|DuckDuckBot|baiduspider|yandex|sogou|bitlybot|tumblr|vkShare|quora link preview|redditbot|ia_archiver|Bingbot|BingPreview|applebot|facebookexternalhit|facebookcatalog|Twitterbot|LinkedInBot|Slackbot|Discordbot|WhatsApp|SkypeUriPreview|Yeti|googleweblight", "bundlePagesRouterDependencies": false, "configFileName": "next.config.ts", "turbopack": { "root": "/Volumes/FilinSky/PROJECTS/Ai Assistant/smart-form-assistant" } };
var BuildId = "bId2jsb9JUP-wW3gU_cZD";
var RoutesManifest = { "basePath": "", "rewrites": { "beforeFiles": [], "afterFiles": [], "fallback": [] }, "redirects": [{ "source": "/:path+/", "destination": "/:path+", "internal": true, "statusCode": 308, "regex": "^(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))/$" }], "routes": { "static": [{ "page": "/", "regex": "^/(?:/)?$", "routeKeys": {}, "namedRegex": "^/(?:/)?$" }, { "page": "/_not-found", "regex": "^/_not\\-found(?:/)?$", "routeKeys": {}, "namedRegex": "^/_not\\-found(?:/)?$" }, { "page": "/favicon.ico", "regex": "^/favicon\\.ico(?:/)?$", "routeKeys": {}, "namedRegex": "^/favicon\\.ico(?:/)?$" }, { "page": "/form", "regex": "^/form(?:/)?$", "routeKeys": {}, "namedRegex": "^/form(?:/)?$" }, { "page": "/login", "regex": "^/login(?:/)?$", "routeKeys": {}, "namedRegex": "^/login(?:/)?$" }], "dynamic": [], "data": { "static": [], "dynamic": [] } }, "locales": [] };
var ConfigHeaders = [];
var PrerenderManifest = { "version": 4, "routes": { "/_not-found": { "initialStatus": 404, "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/_not-found", "dataRoute": "/_not-found.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/favicon.ico": { "initialHeaders": { "cache-control": "public, max-age=0, must-revalidate", "content-type": "image/x-icon", "x-next-cache-tags": "_N_T_/layout,_N_T_/favicon.ico/layout,_N_T_/favicon.ico/route,_N_T_/favicon.ico" }, "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/favicon.ico", "dataRoute": null, "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/form": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/form", "dataRoute": "/form.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/login": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/login", "dataRoute": "/login.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/": { "experimentalBypassFor": [{ "type": "header", "key": "next-action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/", "dataRoute": "/index.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] } }, "dynamicRoutes": {}, "notFoundRoutes": [], "preview": { "previewModeId": "fce9c5f8d5a5bd014b6b82678febcc04", "previewModeSigningKey": "5776829be350f29f1711a8010ea925ecb63545a8081ef86dbfb9d4e81b6684fc", "previewModeEncryptionKey": "163f935b0f279abbac4b48384b3f7717eb283200eacc6d10bab4acfde03ba5d5" } };
var MiddlewareManifest = { "version": 3, "middleware": { "/": { "files": ["server/edge-runtime-webpack.js", "server/middleware.js"], "name": "middleware", "page": "/", "matchers": [{ "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/form(?:\\/((?:[^\\/#\\?]+?)(?:\\/(?:[^\\/#\\?]+?))*))?(\\.json)?[\\/#\\?]?$", "originalSource": "/form/:path*" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "bId2jsb9JUP-wW3gU_cZD", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "vhrNV0e59L9LVZqH+t/2PMBVZeF63Q58khgqVBhWbMA=", "__NEXT_PREVIEW_MODE_ID": "fce9c5f8d5a5bd014b6b82678febcc04", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "5776829be350f29f1711a8010ea925ecb63545a8081ef86dbfb9d4e81b6684fc", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "163f935b0f279abbac4b48384b3f7717eb283200eacc6d10bab4acfde03ba5d5" } } }, "functions": { "/api/ai/usage/route": { "files": ["server/server-reference-manifest.js", "server/app/api/ai/usage/route_client-reference-manifest.js", "server/middleware-build-manifest.js", "server/middleware-react-loadable-manifest.js", "server/next-font-manifest.js", "server/interception-route-rewrite-manifest.js", "server/edge-runtime-webpack.js", "server/edge-chunks/916.js", "server/edge-chunks/973.js", "server/app/api/ai/usage/route.js"], "name": "app/api/ai/usage/route", "page": "/api/ai/usage/route", "matchers": [{ "regexp": "^/api/ai/usage$", "originalSource": "/api/ai/usage" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "bId2jsb9JUP-wW3gU_cZD", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "vhrNV0e59L9LVZqH+t/2PMBVZeF63Q58khgqVBhWbMA=", "__NEXT_PREVIEW_MODE_ID": "fce9c5f8d5a5bd014b6b82678febcc04", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "5776829be350f29f1711a8010ea925ecb63545a8081ef86dbfb9d4e81b6684fc", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "163f935b0f279abbac4b48384b3f7717eb283200eacc6d10bab4acfde03ba5d5" } }, "/api/ai/autofill/route": { "files": ["server/server-reference-manifest.js", "server/app/api/ai/autofill/route_client-reference-manifest.js", "server/middleware-build-manifest.js", "server/middleware-react-loadable-manifest.js", "server/next-font-manifest.js", "server/interception-route-rewrite-manifest.js", "server/edge-runtime-webpack.js", "server/edge-chunks/916.js", "server/edge-chunks/973.js", "server/edge-chunks/165.js", "server/app/api/ai/autofill/route.js"], "name": "app/api/ai/autofill/route", "page": "/api/ai/autofill/route", "matchers": [{ "regexp": "^/api/ai/autofill$", "originalSource": "/api/ai/autofill" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "bId2jsb9JUP-wW3gU_cZD", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "vhrNV0e59L9LVZqH+t/2PMBVZeF63Q58khgqVBhWbMA=", "__NEXT_PREVIEW_MODE_ID": "fce9c5f8d5a5bd014b6b82678febcc04", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "5776829be350f29f1711a8010ea925ecb63545a8081ef86dbfb9d4e81b6684fc", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "163f935b0f279abbac4b48384b3f7717eb283200eacc6d10bab4acfde03ba5d5" } }, "/api/ai/improve/route": { "files": ["server/server-reference-manifest.js", "server/app/api/ai/improve/route_client-reference-manifest.js", "server/middleware-build-manifest.js", "server/middleware-react-loadable-manifest.js", "server/next-font-manifest.js", "server/interception-route-rewrite-manifest.js", "server/edge-runtime-webpack.js", "server/edge-chunks/916.js", "server/edge-chunks/973.js", "server/edge-chunks/165.js", "server/app/api/ai/improve/route.js"], "name": "app/api/ai/improve/route", "page": "/api/ai/improve/route", "matchers": [{ "regexp": "^/api/ai/improve$", "originalSource": "/api/ai/improve" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "bId2jsb9JUP-wW3gU_cZD", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "vhrNV0e59L9LVZqH+t/2PMBVZeF63Q58khgqVBhWbMA=", "__NEXT_PREVIEW_MODE_ID": "fce9c5f8d5a5bd014b6b82678febcc04", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "5776829be350f29f1711a8010ea925ecb63545a8081ef86dbfb9d4e81b6684fc", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "163f935b0f279abbac4b48384b3f7717eb283200eacc6d10bab4acfde03ba5d5" } }, "/api/auth/logout/route": { "files": ["server/server-reference-manifest.js", "server/app/api/auth/logout/route_client-reference-manifest.js", "server/middleware-build-manifest.js", "server/middleware-react-loadable-manifest.js", "server/next-font-manifest.js", "server/interception-route-rewrite-manifest.js", "server/edge-runtime-webpack.js", "server/edge-chunks/916.js", "server/edge-chunks/973.js", "server/app/api/auth/logout/route.js"], "name": "app/api/auth/logout/route", "page": "/api/auth/logout/route", "matchers": [{ "regexp": "^/api/auth/logout$", "originalSource": "/api/auth/logout" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "bId2jsb9JUP-wW3gU_cZD", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "vhrNV0e59L9LVZqH+t/2PMBVZeF63Q58khgqVBhWbMA=", "__NEXT_PREVIEW_MODE_ID": "fce9c5f8d5a5bd014b6b82678febcc04", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "5776829be350f29f1711a8010ea925ecb63545a8081ef86dbfb9d4e81b6684fc", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "163f935b0f279abbac4b48384b3f7717eb283200eacc6d10bab4acfde03ba5d5" } }, "/api/auth/session/route": { "files": ["server/server-reference-manifest.js", "server/app/api/auth/session/route_client-reference-manifest.js", "server/middleware-build-manifest.js", "server/middleware-react-loadable-manifest.js", "server/next-font-manifest.js", "server/interception-route-rewrite-manifest.js", "server/edge-runtime-webpack.js", "server/edge-chunks/916.js", "server/edge-chunks/973.js", "server/app/api/auth/session/route.js"], "name": "app/api/auth/session/route", "page": "/api/auth/session/route", "matchers": [{ "regexp": "^/api/auth/session$", "originalSource": "/api/auth/session" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "bId2jsb9JUP-wW3gU_cZD", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "vhrNV0e59L9LVZqH+t/2PMBVZeF63Q58khgqVBhWbMA=", "__NEXT_PREVIEW_MODE_ID": "fce9c5f8d5a5bd014b6b82678febcc04", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "5776829be350f29f1711a8010ea925ecb63545a8081ef86dbfb9d4e81b6684fc", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "163f935b0f279abbac4b48384b3f7717eb283200eacc6d10bab4acfde03ba5d5" } }, "/api/auth/start/route": { "files": ["server/server-reference-manifest.js", "server/app/api/auth/start/route_client-reference-manifest.js", "server/middleware-build-manifest.js", "server/middleware-react-loadable-manifest.js", "server/next-font-manifest.js", "server/interception-route-rewrite-manifest.js", "server/edge-runtime-webpack.js", "server/edge-chunks/916.js", "server/edge-chunks/165.js", "server/app/api/auth/start/route.js"], "name": "app/api/auth/start/route", "page": "/api/auth/start/route", "matchers": [{ "regexp": "^/api/auth/start$", "originalSource": "/api/auth/start" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "bId2jsb9JUP-wW3gU_cZD", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "vhrNV0e59L9LVZqH+t/2PMBVZeF63Q58khgqVBhWbMA=", "__NEXT_PREVIEW_MODE_ID": "fce9c5f8d5a5bd014b6b82678febcc04", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "5776829be350f29f1711a8010ea925ecb63545a8081ef86dbfb9d4e81b6684fc", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "163f935b0f279abbac4b48384b3f7717eb283200eacc6d10bab4acfde03ba5d5" } }, "/api/auth/verify/route": { "files": ["server/server-reference-manifest.js", "server/app/api/auth/verify/route_client-reference-manifest.js", "server/middleware-build-manifest.js", "server/middleware-react-loadable-manifest.js", "server/next-font-manifest.js", "server/interception-route-rewrite-manifest.js", "server/edge-runtime-webpack.js", "server/edge-chunks/916.js", "server/app/api/auth/verify/route.js"], "name": "app/api/auth/verify/route", "page": "/api/auth/verify/route", "matchers": [{ "regexp": "^/api/auth/verify$", "originalSource": "/api/auth/verify" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "bId2jsb9JUP-wW3gU_cZD", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "vhrNV0e59L9LVZqH+t/2PMBVZeF63Q58khgqVBhWbMA=", "__NEXT_PREVIEW_MODE_ID": "fce9c5f8d5a5bd014b6b82678febcc04", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "5776829be350f29f1711a8010ea925ecb63545a8081ef86dbfb9d4e81b6684fc", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "163f935b0f279abbac4b48384b3f7717eb283200eacc6d10bab4acfde03ba5d5" } }, "/api/forms/progress/route": { "files": ["server/server-reference-manifest.js", "server/app/api/forms/progress/route_client-reference-manifest.js", "server/middleware-build-manifest.js", "server/middleware-react-loadable-manifest.js", "server/next-font-manifest.js", "server/interception-route-rewrite-manifest.js", "server/edge-runtime-webpack.js", "server/edge-chunks/916.js", "server/edge-chunks/973.js", "server/app/api/forms/progress/route.js"], "name": "app/api/forms/progress/route", "page": "/api/forms/progress/route", "matchers": [{ "regexp": "^/api/forms/progress$", "originalSource": "/api/forms/progress" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "bId2jsb9JUP-wW3gU_cZD", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "vhrNV0e59L9LVZqH+t/2PMBVZeF63Q58khgqVBhWbMA=", "__NEXT_PREVIEW_MODE_ID": "fce9c5f8d5a5bd014b6b82678febcc04", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "5776829be350f29f1711a8010ea925ecb63545a8081ef86dbfb9d4e81b6684fc", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "163f935b0f279abbac4b48384b3f7717eb283200eacc6d10bab4acfde03ba5d5" } }, "/api/forms/save/route": { "files": ["server/server-reference-manifest.js", "server/app/api/forms/save/route_client-reference-manifest.js", "server/middleware-build-manifest.js", "server/middleware-react-loadable-manifest.js", "server/next-font-manifest.js", "server/interception-route-rewrite-manifest.js", "server/edge-runtime-webpack.js", "server/edge-chunks/916.js", "server/edge-chunks/973.js", "server/edge-chunks/165.js", "server/app/api/forms/save/route.js"], "name": "app/api/forms/save/route", "page": "/api/forms/save/route", "matchers": [{ "regexp": "^/api/forms/save$", "originalSource": "/api/forms/save" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "bId2jsb9JUP-wW3gU_cZD", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "vhrNV0e59L9LVZqH+t/2PMBVZeF63Q58khgqVBhWbMA=", "__NEXT_PREVIEW_MODE_ID": "fce9c5f8d5a5bd014b6b82678febcc04", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "5776829be350f29f1711a8010ea925ecb63545a8081ef86dbfb9d4e81b6684fc", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "163f935b0f279abbac4b48384b3f7717eb283200eacc6d10bab4acfde03ba5d5" } }, "/api/forms/submissions/route": { "files": ["server/server-reference-manifest.js", "server/app/api/forms/submissions/route_client-reference-manifest.js", "server/middleware-build-manifest.js", "server/middleware-react-loadable-manifest.js", "server/next-font-manifest.js", "server/interception-route-rewrite-manifest.js", "server/edge-runtime-webpack.js", "server/edge-chunks/916.js", "server/edge-chunks/973.js", "server/app/api/forms/submissions/route.js"], "name": "app/api/forms/submissions/route", "page": "/api/forms/submissions/route", "matchers": [{ "regexp": "^/api/forms/submissions$", "originalSource": "/api/forms/submissions" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "bId2jsb9JUP-wW3gU_cZD", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "vhrNV0e59L9LVZqH+t/2PMBVZeF63Q58khgqVBhWbMA=", "__NEXT_PREVIEW_MODE_ID": "fce9c5f8d5a5bd014b6b82678febcc04", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "5776829be350f29f1711a8010ea925ecb63545a8081ef86dbfb9d4e81b6684fc", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "163f935b0f279abbac4b48384b3f7717eb283200eacc6d10bab4acfde03ba5d5" } }, "/api/forms/submit/route": { "files": ["server/server-reference-manifest.js", "server/app/api/forms/submit/route_client-reference-manifest.js", "server/middleware-build-manifest.js", "server/middleware-react-loadable-manifest.js", "server/next-font-manifest.js", "server/interception-route-rewrite-manifest.js", "server/edge-runtime-webpack.js", "server/edge-chunks/916.js", "server/edge-chunks/973.js", "server/edge-chunks/165.js", "server/app/api/forms/submit/route.js"], "name": "app/api/forms/submit/route", "page": "/api/forms/submit/route", "matchers": [{ "regexp": "^/api/forms/submit$", "originalSource": "/api/forms/submit" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "bId2jsb9JUP-wW3gU_cZD", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "vhrNV0e59L9LVZqH+t/2PMBVZeF63Q58khgqVBhWbMA=", "__NEXT_PREVIEW_MODE_ID": "fce9c5f8d5a5bd014b6b82678febcc04", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "5776829be350f29f1711a8010ea925ecb63545a8081ef86dbfb9d4e81b6684fc", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "163f935b0f279abbac4b48384b3f7717eb283200eacc6d10bab4acfde03ba5d5" } }, "/api/ai/validate/route": { "files": ["server/server-reference-manifest.js", "server/app/api/ai/validate/route_client-reference-manifest.js", "server/middleware-build-manifest.js", "server/middleware-react-loadable-manifest.js", "server/next-font-manifest.js", "server/interception-route-rewrite-manifest.js", "server/edge-runtime-webpack.js", "server/edge-chunks/916.js", "server/edge-chunks/973.js", "server/edge-chunks/165.js", "server/app/api/ai/validate/route.js"], "name": "app/api/ai/validate/route", "page": "/api/ai/validate/route", "matchers": [{ "regexp": "^/api/ai/validate$", "originalSource": "/api/ai/validate" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "bId2jsb9JUP-wW3gU_cZD", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "vhrNV0e59L9LVZqH+t/2PMBVZeF63Q58khgqVBhWbMA=", "__NEXT_PREVIEW_MODE_ID": "fce9c5f8d5a5bd014b6b82678febcc04", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "5776829be350f29f1711a8010ea925ecb63545a8081ef86dbfb9d4e81b6684fc", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "163f935b0f279abbac4b48384b3f7717eb283200eacc6d10bab4acfde03ba5d5" } } }, "sortedMiddleware": ["/"] };
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/favicon.ico/route": "/favicon.ico", "/login/page": "/login", "/form/page": "/form", "/page": "/", "/api/ai/usage/route": "/api/ai/usage", "/api/ai/autofill/route": "/api/ai/autofill", "/api/ai/improve/route": "/api/ai/improve", "/api/auth/logout/route": "/api/auth/logout", "/api/auth/session/route": "/api/auth/session", "/api/auth/start/route": "/api/auth/start", "/api/auth/verify/route": "/api/auth/verify", "/api/forms/progress/route": "/api/forms/progress", "/api/forms/save/route": "/api/forms/save", "/api/forms/submissions/route": "/api/forms/submissions", "/api/forms/submit/route": "/api/forms/submit", "/api/ai/validate/route": "/api/ai/validate" };
var FunctionsConfigManifest = { "version": 1, "functions": { "/api/ai/autofill": {}, "/api/ai/improve": {}, "/api/ai/usage": {}, "/api/auth/logout": {}, "/api/auth/session": {}, "/api/ai/validate": {}, "/api/auth/start": {}, "/api/auth/verify": {}, "/api/forms/progress": {}, "/api/forms/save": {}, "/api/forms/submissions": {}, "/api/forms/submit": {} } };
